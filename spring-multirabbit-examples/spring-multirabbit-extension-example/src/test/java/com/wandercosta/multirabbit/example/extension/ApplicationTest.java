package com.wandercosta.multirabbit.example.extension;
...
class ApplicationTest {
    ...
    void shouldResolveContainerFactoryBeans() {
        ...
        assertTrue(beans.containsAll(Arrays.asList("rabbitListenerContainerFactory",
                ExtendedConfiguration.EXTENDED_CONNECTION_A,
                ExtendedConfiguration.EXTENDED_CONNECTION_B, ExtendedConfiguration.EXTENDED_CONNECTION_C)));
    ...
    void shouldResolveRabbitAdminBeans() {
        ...
        Assertions.assertThat(beans).contains(
                ...
                ExtendedConfiguration.EXTENDED_CONNECTION_A + MultiRabbitConstants.RABBIT_ADMIN_SUFFIX,
                ExtendedConfiguration.EXTENDED_CONNECTION_B + MultiRabbitConstants.RABBIT_ADMIN_SUFFIX,
                ExtendedConfiguration.EXTENDED_CONNECTION_C + MultiRabbitConstants.RABBIT_ADMIN_SUFFIX);
